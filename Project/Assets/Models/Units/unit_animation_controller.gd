...
func _ready():
	for i in multimesh.mesh.get_surface_count():
		multimesh.mesh.surface_get_material(i).set_shader_parameter("model_y_rotation_deg",rotation_offset)
		multimesh.mesh.surface_get_material(i).set_shader_parameter("vert_offset",vert_offset)
